 ...
 * @author Karina
 */
public class MaquinaNueva extends javax.swing.JInternalFrame {

    /**
     * Creates new form MaquinaNueva
     */
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if((jTextField1.getText().trim().isEmpty()) ||(jTextArea1.getText().trim().isEmpty()) ){
            ...
            mycontroladorconfiguracion.guardamaquina(nombre, descripcion, estado, actividad);
            lbj.LBJ.Login.escritorio.maquina.refreshMaquinasTable();
            this.dispose();
            
            mycontroladorseguridad.insertarlog(usuario, new Date(), "Insertar", "Maquina", "Insertar Maquina");
